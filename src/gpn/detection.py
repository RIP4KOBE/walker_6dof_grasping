...
from gpn import vis
from gpn.grasp import *
from gpn.utils.transform import Transform, Rotation
from gpn.networks import load_network
...
def select(qual_vol, rot_vol, width_vol, threshold=0.85, max_filter_size=4): 
    ...
    mask = np.where(qual_vol, 1.0, 0.0)#satisfy the condition qual_vol,output 1.0,otherwise output 0.0(lz commented)
